...
The common module provides shared utilities, types, and configurations used throughout RustBot.
...
### `types.rs`
Shared data structures and type definitions used across modules
...
**This feature will certainly not work outside linux**